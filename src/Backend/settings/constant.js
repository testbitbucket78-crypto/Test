...
var checkDeletedColumn = `
    ...
    // Query to permanently delete previous soft-deleted columns before reusing
var permanentDeleteColumn = `
DELETE FROM SPIDCustomContactFields 
WHERE SP_ID=? 
  AND CustomColumn=? 
  AND isDeleted=1`;
...
var addTemplates = `INSERT INTO templateMessages (TemplateName,Channel,Category,Language,media_type,Header,BodyText,Links,FooterText,template_json,status,spid,created_By,created_at,isTemplate,industry,category_id,templateID,buttons,categoryChange,quality,interactive_buttons,renderedButtons,metaUploadedId) VALUES ?`
...
var insertHealthStatus = `INSERT INTO businessHealth (phone_number_id, channel_phone_number, balance_limit_today, quality_rating, created_at, fb_verification, SP_ID, isWebhookRegistered, isWhatsAppRegistered) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`;
