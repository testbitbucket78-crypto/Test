...
//var getInteractionMapping = "SELECT i.MappingId, i.InteractionId, i.AgentId, i.MappedBy, i.is_active, i.created_at, i.lastAssistedAgent, i.updated_at, i.isAgentInactiveTimeOut, u.password, u.email_id, u.address, u.mobile_number, u.country, u.timezone, u.CreatedDate, u.LastModifiedDate, u.PasswordHint, u.securityquestion, u.Securityanswer, u.ParentId, u.UserType, u.isDeleted, u.IsActive, u.SP_ID, u.profile_img, u.LoginIP, u.country_code, u.LastLogIn, u.display_mobile_number, u.registerPhone, u.isAutoScanOnce, u.Channel, u.partnerId, u.remark, u.isTokenExpire, u.isDisable, u.isPaused, u.token_to_use, u.server_type, u.isPlanExpired,COALESCE(u.uid, -4) AS uid,CASE WHEN i.AgentId = -4 THEN 'Bot' ELSE u.name END AS name FROM InteractionMapping i LEFT JOIN user u ON u.uid = i.AgentId WHERE i.is_active = 1 AND i.InteractionId =? AND i.AgentId <> -1 ORDER BY i.MappingId DESC LIMIT 1"


var getInteractionMapping="SELECT i.MappingId,i.InteractionId,i.AgentId,i.MappedBy,i.is_active,i.created_at,i.lastAssistedAgent,i.updated_at,i.isAgentInactiveTimeOut,u.password,u.email_id,u.address,u.mobile_number,u.country,u.timezone,u.CreatedDate,u.LastModifiedDate,u.PasswordHint,u.securityquestion,u.Securityanswer,u.ParentId,u.UserType,u.isDeleted,u.IsActive,u.SP_ID,u.profile_img,u.LoginIP,u.country_code,u.LastLogIn,u.display_mobile_number,u.registerPhone,u.isAutoScanOnce,u.Channel,u.partnerId,u.remark,u.isTokenExpire,u.isDisable,u.isPaused,u.token_to_use,u.server_type,u.isPlanExpired,COALESCE(u.uid,-4) AS uid,CASE WHEN i.AgentId=-4 THEN 'Bot' ELSE u.name END AS name FROM InteractionMapping i LEFT JOIN user u ON u.uid=i.AgentId WHERE i.is_active=1 AND i.InteractionId=? AND (SELECT AgentId FROM InteractionMapping WHERE InteractionId=i.InteractionId ORDER BY MappingId DESC LIMIT 1)<>-1 ORDER BY i.MappingId DESC LIMIT 1";
