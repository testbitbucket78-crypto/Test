...
async function channelssetUp(spid,channelType, mediaType, messageTo, message_body) {
    try{
...
console.log(WhatsAppOfficialMessage)
    ...
    let messages=await postDataToAPI(spid,phoneNumber,mediaType,content,content) 
