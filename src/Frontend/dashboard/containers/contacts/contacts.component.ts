...
export class ContactsComponent implements OnInit {
  ...
  openedit(contactedit: any) {
   // console.log(sessionStorage.getItem('id'))
    this.apiService.getContactById(sessionStorage.getItem('id')).subscribe((result: any) => {
      ...
      // this.Phone_number=result[0].Phone_number
      // this.emailId=result[0].emailId
      // this.age=result[0].age
      // this.edittag=[result[0].tag]
      // this.editstatus=[result[0].status]
      // this.facebookId=result[0].facebookId
      // this.InstagramId=result[0].InstagramId
       this.editContact = this.fb.group({
  ...
  opensidenav(employee: any) {
    // sessionStorage.setItem('contactById', employee.customerId)
