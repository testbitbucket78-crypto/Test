...
getRightsList(){
  this._settingsService.getRightsList()
  .subscribe(result =>{
    if(result){
...
getSubRightsList(){
  this._settingsService.getSubRightsList()
  .subscribe(result =>{
    if(result){
      console.log(result);
...
searchData(srchText:string){
 ...
 subRightRes= [
  ...
  },
  {
      "id": 12,
      "rightsID": 3,
      "subRights": "View unassigned conversations, assigned to me (open and my resolved), assigned to my team as a whole and where I am mentioned in notes",
      "isDeleted": 0,
  ...
  },
  {
      "id": 13,
      "rightsID": 3,
      "subRights": "View conversations assigned to any member in my team (open and resolved by them)",
      "isDeleted": 0,
  ...
  },
  {
      "id": 14,
      "rightsID": 3,
      "subRights": "View conversations assigned to any member in any team (open and resolved by them)",
      "isDeleted": 0,
